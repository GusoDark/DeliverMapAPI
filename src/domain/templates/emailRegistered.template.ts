...
export function generateOrderEmailTemplate(lat: number, lng: number): string {
...
<head>
    ...
    <title>Actualización: PEDIDO REGISTRADO</title>
</head>
<body>
    <div class="container">
        <div class="header">
            <h1>Su pedido ha sido registrado con éxito</h1>
        </div>
        <div class="content">
            <h2>Pedido registrado en la ubicación: </h2>
            <p>Latitud: ${lat}</p>
            <p>Longitud: ${lng}</p>
